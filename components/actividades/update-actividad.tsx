...
import { Actividad, Status } from "@prisma/client";

export default function UpdateActividad({ actividad }: { actividad: Actividad }) {
            ...
            <DialogContent className="sm:max-w-[425px] overflow-auto bg-white">
                ...
                <ActividadForm
                    defaultValues={{
                        ...
                        idMeta: actividad.idMeta || "",
                        idStatus: actividad.status == Status.activo ? "0" : "1",                        
                    }}
                    onSubmit={onSubmit}

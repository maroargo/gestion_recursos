...
export default function CreatePlanificacion() {  
  ...
  const onSubmit = async (info: PlanificacionSchema) => {
    ...
    try {
      ...
      reader.onload = async (e) => {
        ...
        try {
          const response = await fetch(`/api/planificacion?idPresupuesto=${info.idPresupuesto}`, {
            method: "POST",
